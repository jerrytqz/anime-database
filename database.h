...
public: 
    ...
    void remove(std::vector<int>& indices, bool safe = true, bool copy = false); 
    ...
    std::vector<int> search_by_name(const std::string& input, bool exact) const;
    ...
    // of. 
    std::vector<int> search_by_studio(const std::string& input, bool exact) const;
